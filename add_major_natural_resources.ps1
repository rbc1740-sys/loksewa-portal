...
$src = Get-SanitizedJson "d:\loksewa-portal\New folder\New folder\Major natural resources of Nepal.json"
$qarr = $src.questions
...
[System.IO.File]::WriteAllText("questions\major_natural_resources.json", $json, (New-Object System.Text.UTF8Encoding($false)))
Write-Output ""
