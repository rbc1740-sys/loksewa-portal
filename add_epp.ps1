...
# --- File: Q1-111 (NEC, ethics, labour act, procurement, professional conduct) ---
$f1 = Get-SanitizedJson "d:\gemini-code-1787449218751.json"
foreach ($q in $f1) {
    ...
    $merged.Add([pscustomobject]@{
        topic       = "Engineering Professional Practice"
...
[System.IO.File]::WriteAllText("questions\engineering_professional_practice.json", $json, (New-Object System.Text.UTF8Encoding($false)))
Write-Output ""
